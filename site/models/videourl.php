 ...
 * @abstract      	Contus HD FLV Player videourl file
 ...
 */
class hdflvplayerModelvideourl extends HdflvplayerModel
{
    ...
    function imgURL()
    {
        ...
        switch ($this->type) {
            ...
            case "break":
                ...
                break;
            case "metacafe":
                preg_match('/link rel="image_src" href="(.*?)" \/>+/', $contents, $result_img);
                $img = urldecode($result_img[1]);
                break;
            case "google":
