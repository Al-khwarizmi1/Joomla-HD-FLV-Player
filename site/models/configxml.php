...
class hdflvplayerModelconfigxml extends HdflvplayerModel {
    ...
    function configgetrecords() {
        ...
        ## Playlist id
        $playid_playlistname = intVal(JRequest::getvar('playid', '', 'get', 'var'));

        ##  Video id;
        $id                 = intVal(JRequest::getvar('id', '', 'get', 'int'));
        ...
        ##  Module video id
        $videoid            = intVal(JRequest::getvar('videoid', '', 'get', 'int'));
        if (version_compare(JVERSION, '3.0.0', 'ge')) {
            $videoid        = intVal(JRequest::getvar('videoid'));
        }
        if ($videoid) {
            $playid         = $videoid;
        }
        ...
        $comppid            = intVal(JRequest::getvar('compid', '', 'get', 'int'));
        if (version_compare(JVERSION, '3.0.0', 'ge')) {
            $comppid        = intVal(JRequest::getvar('compid'));
        }
    ...
    function configxml($rs_moduleparams, $settingsrows, $playid, $playid_playlistname, $moduleid, $comppid, $base, $allowmidrollads) {
        ...
        $emailpath              = $base . 'index.php?option=com_hdflvplayer&task=email';
