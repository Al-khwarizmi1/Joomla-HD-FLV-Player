...
class hdflvplayerController extends ContushdflvplayerController {
	...
	function savelanguagesetup() {
		if ($model = $this->getModel('editlanguage')) {
			$model->savelanguagesetup(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function saveplayersettings() {
		if ($model = $this->getModel('playersettings')) {
			$model->saveplayersettings(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function saveplaylistname() {
		if ($model = $this->getModel('editplaylistname')) {
			$model->saveplaylistname(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function saveads() {
		if ($model = $this->getModel('showads')) {
			$model->saveads(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function savevideoupload() {
		...
		if ($model = $this->getModel('editvideoupload')) {
			//Push the model into the view (as default)
			//Second parameter indicates that it is the default model for the view
			$model->savevideouploadmodel(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function trash() {
		...
		if ($model = $this->getModel('publish')) {
			//Push the model into the view (as default)
			//Second parameter indicates that it is the default model for the view
			$model->publishmodel(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function resethits() {
		...
		if ($model = $this->getModel('uploadvideos')) {
			//Push the model into the view (as default)
			//Second parameter indicates that it is the default model for the view
			$model->resethitsmodel(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function saveaddgoogle() {
		if ($model = $this->getModel('addgoogle')) {
			$model->saveaddgoogle(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function hdflvplayerinstall() {
		if ($model = $this->getModel('hdflvplayerinstall')) {
			$model->install(strip_tags(JRequest::getVar('task')));
		}
	}

	function hdflvplayerupgrade() {
		if ($model = $this->getModel('hdflvplayerupgrade')) {
			$model->upgrade(strip_tags(JRequest::getVar('task')));
		}
	}
	...
	function controlpanel()
	{
		...
		$viewName = strip_tags(JRequest::getVar('view', 'controlpanel'));
        $viewLayout = strip_tags(JRequest::getVar('layout', 'default'));
